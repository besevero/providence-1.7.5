...
CREATE TABLE `ca_loans_x_collections` (
  ...
  CONSTRAINT `fk_ca_loans_x_collections_collection_id` FOREIGN KEY (`collection_id`) REFERENCES `ca_collections` (`collection_id`),
  CONSTRAINT `fk_ca_loans_x_collections_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_loan_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_collections_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_collection_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_collections_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `ca_loans` (`loan_id`),
  CONSTRAINT `fk_ca_loans_x_collections_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:21:58
