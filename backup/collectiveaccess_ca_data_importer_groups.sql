...
CREATE TABLE `ca_data_importer_groups` (
  ...
  CONSTRAINT `fk_ca_data_importer_groups_importer_id` FOREIGN KEY (`importer_id`) REFERENCES `ca_data_importers` (`importer_id`)
...
-- Dump completed on 2018-03-08 22:21:41
