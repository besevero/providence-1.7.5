...
CREATE TABLE `ca_metadata_dictionary_rules` (
  ...
  CONSTRAINT `fk_ca_metadata_dictionary_rules_entry_id` FOREIGN KEY (`entry_id`) REFERENCES `ca_metadata_dictionary_entries` (`entry_id`)
...
-- Dump completed on 2018-03-08 22:22:31
