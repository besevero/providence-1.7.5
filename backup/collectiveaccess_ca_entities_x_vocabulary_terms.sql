...
CREATE TABLE `ca_entities_x_vocabulary_terms` (
  ...
  CONSTRAINT `fk_ca_entities_x_vocabulary_terms_entity_id` FOREIGN KEY (`entity_id`) REFERENCES `ca_entities` (`entity_id`),
  CONSTRAINT `fk_ca_entities_x_vocabulary_terms_item_id` FOREIGN KEY (`item_id`) REFERENCES `ca_list_items` (`item_id`),
  CONSTRAINT `fk_ca_entities_x_vocabulary_terms_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_entity_labels` (`label_id`),
  CONSTRAINT `fk_ca_entities_x_vocabulary_terms_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_list_item_labels` (`label_id`),
  CONSTRAINT `fk_ca_entities_x_vocabulary_terms_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:22:06
