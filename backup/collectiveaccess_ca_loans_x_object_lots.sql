...
CREATE TABLE `ca_loans_x_object_lots` (
  ...
  CONSTRAINT `fk_ca_loans_x_object_lots_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_loan_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_object_lots_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_object_lot_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_object_lots_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `ca_loans` (`loan_id`),
  CONSTRAINT `fk_ca_loans_x_object_lots_lot_id` FOREIGN KEY (`lot_id`) REFERENCES `ca_object_lots` (`lot_id`),
  CONSTRAINT `fk_ca_loans_x_object_lots_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:20:53
