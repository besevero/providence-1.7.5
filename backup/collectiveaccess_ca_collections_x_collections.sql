...
CREATE TABLE `ca_collections_x_collections` (
  ...
  CONSTRAINT `fk_ca_collections_x_collections_collection_left_id` FOREIGN KEY (`collection_left_id`) REFERENCES `ca_collections` (`collection_id`),
  CONSTRAINT `fk_ca_collections_x_collections_collection_right_id` FOREIGN KEY (`collection_right_id`) REFERENCES `ca_collections` (`collection_id`),
  CONSTRAINT `fk_ca_collections_x_collections_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_collection_labels` (`label_id`),
  CONSTRAINT `fk_ca_collections_x_collections_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_collection_labels` (`label_id`),
  CONSTRAINT `fk_ca_collections_x_collections_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:22:03
