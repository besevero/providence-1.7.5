...
CREATE TABLE `ca_loans_x_objects` (
  ...
  CONSTRAINT `fk_ca_loans_x_objects_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_loan_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_objects_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_object_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_objects_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `ca_loans` (`loan_id`),
  CONSTRAINT `fk_ca_loans_x_objects_object_id` FOREIGN KEY (`object_id`) REFERENCES `ca_objects` (`object_id`),
  CONSTRAINT `fk_ca_loans_x_objects_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
