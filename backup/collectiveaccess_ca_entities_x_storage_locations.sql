...
CREATE TABLE `ca_entities_x_storage_locations` (
  ...
  CONSTRAINT `fk_ca_entities_x_storage_locations_entity_id` FOREIGN KEY (`entity_id`) REFERENCES `ca_entities` (`entity_id`),
  CONSTRAINT `fk_ca_entities_x_storage_locations_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_entity_labels` (`label_id`),
  CONSTRAINT `fk_ca_entities_x_storage_locations_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_storage_location_labels` (`label_id`),
  CONSTRAINT `fk_ca_entities_x_storage_locations_location_id` FOREIGN KEY (`location_id`) REFERENCES `ca_storage_locations` (`location_id`),
  CONSTRAINT `fk_ca_entities_x_storage_locations_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:22:37
