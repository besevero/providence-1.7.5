...
CREATE TABLE `ca_loans_x_movements` (
  ...
  CONSTRAINT `fk_ca_loans_x_movement_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_movement_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_movements_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_loan_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_movements_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `ca_loans` (`loan_id`),
  CONSTRAINT `fk_ca_loans_x_movements_movement_id` FOREIGN KEY (`movement_id`) REFERENCES `ca_movements` (`movement_id`),
  CONSTRAINT `fk_ca_loans_x_movements_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:23:13
