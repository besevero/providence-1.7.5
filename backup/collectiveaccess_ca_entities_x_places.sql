...
CREATE TABLE `ca_entities_x_places` (
  ...
  CONSTRAINT `fk_ca_entities_x_places_entity_id` FOREIGN KEY (`entity_id`) REFERENCES `ca_entities` (`entity_id`),
  CONSTRAINT `fk_ca_entities_x_places_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_entity_labels` (`label_id`),
  CONSTRAINT `fk_ca_entities_x_places_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_place_labels` (`label_id`),
  CONSTRAINT `fk_ca_entities_x_places_place_id` FOREIGN KEY (`place_id`) REFERENCES `ca_places` (`place_id`),
  CONSTRAINT `fk_ca_entities_x_places_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:22:36
