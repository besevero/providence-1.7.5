...
CREATE TABLE `ca_movements_x_object_representations` (
  ...
  CONSTRAINT `fk_ca_movements_x_object_representations_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_object_representation_labels` (`label_id`),
  CONSTRAINT `fk_ca_movements_x_object_representations_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_movement_labels` (`label_id`),
  CONSTRAINT `fk_ca_movements_x_object_representations_movement_id` FOREIGN KEY (`movement_id`) REFERENCES `ca_movements` (`movement_id`),
  CONSTRAINT `fk_ca_movements_x_object_representations_representation_id` FOREIGN KEY (`representation_id`) REFERENCES `ca_object_representations` (`representation_id`),
  CONSTRAINT `fk_ca_movements_x_object_representations_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:22:27
