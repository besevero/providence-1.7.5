...
CREATE TABLE `ca_movements_x_occurrences` (
  ...
  CONSTRAINT `fk_ca_movements_x_occurrences_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_movement_labels` (`label_id`),
  CONSTRAINT `fk_ca_movements_x_occurrences_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_occurrence_labels` (`label_id`),
  CONSTRAINT `fk_ca_movements_x_occurrences_movement_id` FOREIGN KEY (`movement_id`) REFERENCES `ca_movements` (`movement_id`),
  CONSTRAINT `fk_ca_movements_x_occurrences_occurrence_id` FOREIGN KEY (`occurrence_id`) REFERENCES `ca_occurrences` (`occurrence_id`),
  CONSTRAINT `fk_ca_movements_x_occurrences_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:21:15
