...
CREATE TABLE `ca_editor_ui_type_restrictions` (
  ...
  CONSTRAINT `fk_ca_editor_ui_type_restrictions_ui_id` FOREIGN KEY (`ui_id`) REFERENCES `ca_editor_uis` (`ui_id`)
...
INSERT INTO `ca_editor_ui_type_restrictions` VALUES (1,72,102,15,0,'Tjs=',1);
...
-- Dump completed on 2018-03-08 22:21:46
