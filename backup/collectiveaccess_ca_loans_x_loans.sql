...
CREATE TABLE `ca_loans_x_loans` (
  ...
  CONSTRAINT `fk_ca_loans_x_loans_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_loan_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_loans_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_loan_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_loans_loan_left_id` FOREIGN KEY (`loan_left_id`) REFERENCES `ca_loans` (`loan_id`),
  CONSTRAINT `fk_ca_loans_x_loans_loan_right_id` FOREIGN KEY (`loan_right_id`) REFERENCES `ca_loans` (`loan_id`),
  CONSTRAINT `fk_ca_loans_x_loans_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:22:23
