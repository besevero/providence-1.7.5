...
CREATE TABLE `ca_movements_x_entities` (
  ...
  CONSTRAINT `fk_ca_movements_x_entities_entity_id` FOREIGN KEY (`entity_id`) REFERENCES `ca_entities` (`entity_id`),
  CONSTRAINT `fk_ca_movements_x_entities_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_movement_labels` (`label_id`),
  CONSTRAINT `fk_ca_movements_x_entities_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_entity_labels` (`label_id`),
  CONSTRAINT `fk_ca_movements_x_entities_movement_id` FOREIGN KEY (`movement_id`) REFERENCES `ca_movements` (`movement_id`),
  CONSTRAINT `fk_ca_movements_x_entities_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:22:52
