...
CREATE TABLE `ca_data_exporter_labels` (
  ...
  CONSTRAINT `fk_ca_data_exporter_labels_exporter_id` FOREIGN KEY (`exporter_id`) REFERENCES `ca_data_exporters` (`exporter_id`),
  CONSTRAINT `fk_ca_data_exporter_labels_locale_id` FOREIGN KEY (`locale_id`) REFERENCES `ca_locales` (`locale_id`)
...
-- Dump completed on 2018-03-08 22:21:38
