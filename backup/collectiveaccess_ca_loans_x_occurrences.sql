...
CREATE TABLE `ca_loans_x_occurrences` (
  ...
  CONSTRAINT `fk_ca_loans_x_occurrences_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_loan_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_occurrences_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_occurrence_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_occurrences_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `ca_loans` (`loan_id`),
  CONSTRAINT `fk_ca_loans_x_occurrences_occurrence_id` FOREIGN KEY (`occurrence_id`) REFERENCES `ca_occurrences` (`occurrence_id`),
  CONSTRAINT `fk_ca_loans_x_occurrences_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:23:25
