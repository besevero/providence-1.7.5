...
CREATE TABLE `ca_loan_labels` (
  ...
  CONSTRAINT `fk_ca_loan_labels_locale_id` FOREIGN KEY (`locale_id`) REFERENCES `ca_locales` (`locale_id`),
  CONSTRAINT `fk_ca_loan_labels_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_list_items` (`item_id`)
...
-- Dump completed on 2018-03-08 22:22:45
