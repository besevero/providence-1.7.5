...
CREATE TABLE `ca_movements_x_objects` (
  ...
  CONSTRAINT `fk_ca_movements_x_objects_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_movement_labels` (`label_id`),
  CONSTRAINT `fk_ca_movements_x_objects_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_object_labels` (`label_id`),
  CONSTRAINT `fk_ca_movements_x_objects_movement_id` FOREIGN KEY (`movement_id`) REFERENCES `ca_movements` (`movement_id`),
  CONSTRAINT `fk_ca_movements_x_objects_object_id` FOREIGN KEY (`object_id`) REFERENCES `ca_objects` (`object_id`),
  CONSTRAINT `fk_ca_movements_x_objects_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:23:36
