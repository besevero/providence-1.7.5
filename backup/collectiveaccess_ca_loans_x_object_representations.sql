...
CREATE TABLE `ca_loans_x_object_representations` (
  ...
  CONSTRAINT `fk_ca_loans_x_object_representations_label_left_id` FOREIGN KEY (`label_left_id`) REFERENCES `ca_object_representation_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_object_representations_label_right_id` FOREIGN KEY (`label_right_id`) REFERENCES `ca_loan_labels` (`label_id`),
  CONSTRAINT `fk_ca_loans_x_object_representations_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `ca_loans` (`loan_id`),
  CONSTRAINT `fk_ca_loans_x_object_representations_representation_id` FOREIGN KEY (`representation_id`) REFERENCES `ca_object_representations` (`representation_id`),
  CONSTRAINT `fk_ca_loans_x_object_representations_type_id` FOREIGN KEY (`type_id`) REFERENCES `ca_relationship_types` (`type_id`)
...
-- Dump completed on 2018-03-08 22:22:05
